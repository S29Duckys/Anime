...
<head>
  ...
  @vite(['resources/css/app.css','resources/css/pages/settings.css','resources/css/admin/dashboard.css','resources/css/admin/user.css','resources/css/pages/login.css','resources/css/pages/register.css','resources/css/pages/catalogue.css','resources/css/pages/maliste.css','resources/css/pages/genres.css','resources/js/admin/user.js','resources/js/app.js','resources/js/components/cursorAnimation.js','resources/js/pages/login.js','resources/js/pages/register.js','resources/js/pages/settings.js','resources/js/admin/dashboard.js','resources/js/pages/catalogue.js'])
  @stack('styles')
  @stack('scripts')
</head>
